...
-- 残疾职工附件表
-- 残疾职工残疾人证附件表
CREATE TABLE `disabled_employee_attachment` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键自增id',
  `employee_id` bigint NOT NULL COMMENT '残疾职工ID，关联company_disabled_employee.id',
  ...
  `file_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文件MIME类型：image/jpeg, image/png等',
  `upload_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '上传时间',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_employee_id`(`employee_id` ASC) USING BTREE,
  CONSTRAINT `fk_attachment_employee` FOREIGN KEY (`employee_id`) REFERENCES `company_disabled_employee` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '残疾职工残疾人证附件表' ROW_FORMAT = DYNAMIC;
-- ----------------------------
